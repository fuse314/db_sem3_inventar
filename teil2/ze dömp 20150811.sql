...
INSERT INTO `Log` VALUES (1,'2015-03-16 23:00:00',2,'Warning: Could not connect to the server',1),(2,'2015-03-16 23:00:00',1,'Information: Connected to Server',2),(3,'2015-03-16 23:00:00',3,'Error: Server unknown',3),(4,'2015-08-11 17:14:14',2,'mal ne Log-message machen.',7),(5,'2015-08-11 17:15:33',2,'mal ne Log-message machen.',7);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `P_PodBill`(id_pod int)
begin
...
-- Dump completed on 2015-08-11 19:22:24
