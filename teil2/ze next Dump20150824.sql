...
DELIMITER ;;
CREATE DEFINER=`rho`@`%` FUNCTION `BetragRechnungMitGutschrift_F`(ID_Invoice int) RETURNS decimal(10,0)
begin
...
/*!50013 DEFINER=`rho`@`%` SQL SECURITY DEFINER */
...
-- Dump completed on 2015-08-24 18:03:37
