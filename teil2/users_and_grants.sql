...
GRANT insert ON inventar.v_devicecatalog TO 'sb'@'%';
GRANT insert ON inventar.v_invoices TO 'sb'@'%';
GRANT insert ON inventar.v_logentries TO 'sb'@'%';
GRANT insert ON inventar.v_usageperlocation TO 'sb'@'%';
GRANT insert ON inventar.v_usageperpod TO 'sb'@'%';
