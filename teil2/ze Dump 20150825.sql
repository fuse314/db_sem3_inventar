CREATE DATABASE  IF NOT EXISTS `inventar` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `inventar`;
-- MySQL dump 10.13  Distrib 5.6.19, for osx10.7 (i386)
--
-- Host: yp.gma.name    Database: inventar
-- ------------------------------------------------------
...
INSERT INTO `credential` VALUES (1,1,'elias.schwarz','734hgsue4','234562dsaf',NULL),(2,1,'melanie.mueller','asdf','dsafewr234',NULL),(3,1,'hans.eberle','1234','234sa4dasf',NULL),(4,1,'marcel.signer','','234sdfawer',NULL);
...
INSERT INTO `customer` VALUES (1,'GemDat Informatik AG',9,10,NULL),(2,'Testfirma',3,9,NULL),(3,'Meisterfirma',2,10,NULL),(11,'MauFirma',NULL,0,1000);
...
INSERT INTO `devicecategory` VALUES (1,'Switch',0),(2,'Router',0),(3,'WLAN Accesspoint',0),(4,'Printer',0),(5,'Workstation',1),(6,'Server',0);
...
INSERT INTO `devicetype` VALUES (1,1,'Cisco','CS4582',5,1,1,'Modell 1000'),(2,2,'DELL','D-388',0,2,1,'Modell 3770'),(3,3,'HP','H-2600',0,3,1,'Modell 4500'),(4,4,'Canon','CN1234',0,2,1,'Modell 2000'),(5,5,'Dell','D-2050',0,3,1,'Modell 3400'),(6,6,'Dell','D-4093',0,1,1,'Modell 2200');
...
INSERT INTO `invoice` VALUES (1,'2015-08-18',1,1),(2,'2015-08-18',2,1),(3,NULL,3,0),(4,NULL,1,0),(5,'2015-07-30',1,1),(13,NULL,11,0),(14,'2015-08-24',11,1);
...
INSERT INTO `invoiceposition` VALUES (1,1,1,100,NULL,'Fahrtweg zu Kunde',NULL,NULL,3),(2,1,1,3,NULL,'Installation Gerät XYZ',NULL,3,3),(3,1,2,1,600,'Gerät XYZ',NULL,2,NULL),(4,2,NULL,1,6000,NULL,1,NULL,NULL),(5,5,NULL,1,1100,NULL,2,NULL,NULL),(8,14,NULL,1,600,'Arbeitsfoo',NULL,NULL,5),(7,14,NULL,1,500,'Fahrtweg',NULL,NULL,5),(9,14,NULL,1,8000,'Material',NULL,NULL,5);
...
INSERT INTO `location` VALUES (1,1,11,NULL,'Uno'),(2,1,12,1,'Duett'),(3,2,11,NULL,'Tresses'),(4,3,14,NULL,'Quattro'),(5,4,11,NULL,'MauLocation');
...
INSERT INTO `log` VALUES (6,'2015-08-12 16:56:28',3,'Is was passiert.',5,0),(7,'2015-08-12 16:57:04',1,'Is was wichtiges passiert.',6,0),(8,'2015-08-24 17:24:54',1,'billed pod',29,0);
...
INSERT INTO `mediumtype` VALUES (1,'RJ-45 CAT6',1000,1,'1000BASE-T');
...
CREATE TABLE `networkinterface` (
  ...
  `Description` varchar(100) DEFAULT NULL,
  `IPv4_SubnetMask` int(10) DEFAULT NULL,
  `IPv4_DefaultGateway` int(10) DEFAULT NULL,
ULL,NULL,NULL,NULL),(36,NULL,NULL,NULL,26,3,NULL,NULL,NULL,NULL,NULL),(37,NULL,NULL,NULL,26,2,NULL,NULL,NULL,NULL,NULL),(38,NULL,NULL,NULL,26,1,NULL,NULL,NULL,NULL,NULL),(39,NULL,NULL,NULL,27,5,NULL,NULL,NULL,NULL,NULL),(40,NULL,NULL,NULL,27,4,NULL,NULL,NULL,NULL,NULL),(41,NULL,NULL,NULL,27,3,NULL,NULL,NULL,NULL,NULL),(42,NULL,NULL,NULL,27,2,NULL,NULL,NULL,NULL,NULL),(43,NULL,NULL,NULL,27,1,NULL,NULL,NULL,NULL,NULL),(44,NULL,NULL,NULL,28,5,NULL,NULL,NULL,NULL,NULL),(45,NULL,NULL,NULL,28,4,NULL,NULL,NULL,NULL,NULL),(46,NULL,NULL,NULL,28,3,NULL,NULL,NULL,NULL,NULL),(47,NULL,NULL,NULL,28,2,NULL,NULL,NULL,NULL,NULL),(48,NULL,NULL,NULL,28,1,NULL,NULL,NULL,NULL,NULL),(49,1,167772216,NULL,29,1,1,NULL,NULL,NULL,NULL),(50,1,168755204,NULL,29,2,1,NULL,NULL,NULL,NULL),(51,1,3232235534,NULL,29,3,1,NULL,NULL,NULL,NULL),(52,1,167783523,NULL,29,4,1,NULL,NULL,NULL,NULL),(53,1,167783524,NULL,29,5,1,NULL,NULL,NULL,NULL);
...
INSERT INTO `payment` VALUES (1,1,100,'2001-01-20'),(2,11,300,'2023-08-20'),(3,11,300,'2015-08-23');
...
CREATE TABLE `pod` (
  ...
  `NameServer` bigint(20) DEFAULT NULL,
  `SntpServer` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID_Pod`),
  KEY `ID_Customer` (`ID_Customer`),
...
INSERT INTO `pod` VALUES (1,1,10,'Europe/Zurich','PodEins',NULL,NULL,NULL),(2,3,1,'Europe/Zurich','PodZwo',NULL,NULL,NULL),(3,3,10,'Europe/Zurich','PodDreiii',NULL,NULL,NULL),(4,11,1,'Schweiz','MauPod',NULL,NULL,NULL);
...
INSERT INTO `relnetworkinterface` VALUES (1,1,8),(2,2,18),(3,3,19),(4,4,20),(5,5,6),(6,7,15),(7,9,21),(8,10,22),(9,11,17),(10,12,13),(11,14,16),(12,51,29),(13,52,36);
...
INSERT INTO `relnetworkinterfacevlan` VALUES (8,1),(10,1),(11,1),(12,1),(13,1);
...
/*!50001 CREATE VIEW `v_devicecatalog` AS SELECT 
 ...
 1 AS `Speed`,
 1 AS `FullDuplex`,
 1 AS `MediumTypeDescription`,
 1 AS `DeviceTypeDescription`,
 1 AS `Price`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_freenetworkinterfaces`
--

DROP TABLE IF EXISTS `v_freenetworkinterfaces`;
/*!50001 DROP VIEW IF EXISTS `v_freenetworkinterfaces`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v_freenetworkinterfaces` AS SELECT 
 1 AS `LocationName`,
 1 AS `Hostname`,
 1 AS `PortNumber`,
 1 AS `mediumtype`,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`fuse314`@`%` FUNCTION `BetragRechnungMitGutschrift_F`(ID_Invoice int) RETURNS decimal(10,0)
begin
...
DELIMITER ;;
CREATE DEFINER=`fuse314`@`%` FUNCTION `BetragRechnungOhneGutschrift_F`(ID_Invoice int) RETURNS decimal(10,0)
    READS SQL DATA
begin
declare sum decimal;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`fuse314`@`%` PROCEDURE `P_DeviceAdd`(in ID_Location int, in ID_DeviceType int, in NumDevice int)
begin
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`fuse314`@`%` PROCEDURE `P_LogClear`(in Id int)
begin
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`fuse314`@`%` PROCEDURE `P_LogMessageAdd`(in ID_Pod int, in Hostname varchar(100), in Severity int, in Message varchar(1000))
begin
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`fuse314`@`%` PROCEDURE `P_NightlyInvoicing`()
begin
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`inp1316_usr`@`%` PROCEDURE `P_PodBill`(id_pod int)
begin
...
/*!50013 DEFINER=`inp1316_usr`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `v_devicecatalog` AS select `dt`.`Manufacturer` AS `Manufacturer`,`dc`.`Description` AS `TypeDescription`,`dt`.`NumInterfaces` AS `NumInterfaces`,`mt`.`Speed` AS `Speed`,`mt`.`FullDuplex` AS `FullDuplex`,`mt`.`Description` AS `MediumTypeDescription`,`dt`.`Description` AS `DeviceTypeDescription`,`r`.`Price` AS `Price` from ((((`devicetype` `dt` join `devicecategory` `dc` on(((`dt`.`ID_DeviceCategory` = `dc`.`ID_DeviceCategory`) and (`dc`.`Inactiv` = 0)))) join `mediumtype` `mt` on((`dt`.`ID_MediumType` = `mt`.`ID_MediumType`))) join `networkinterface` `i` on((`mt`.`ID_MediumType` = `i`.`ID_MediumType`))) join `rate` `r` on((`dt`.`ID_Rate` = `r`.`ID_Rate`))) group by `dt`.`Manufacturer`,`dc`.`Description` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_freenetworkinterfaces`
--
...
/*!50001 VIEW `v_freenetworkinterfaces` AS select `l`.`Description` AS `LocationName`,`d`.`Hostname` AS `Hostname`,`ni`.`PortNr` AS `PortNumber`,`mt`.`Description` AS `mediumtype`,`mt`.`Speed` AS `MaxSpeed` from ((((`networkinterface` `ni` join `device` `d` on((`d`.`ID_Device` = `ni`.`ID_Device`))) join `location` `l` on((`l`.`ID_Location` = `d`.`ID_Location`))) join `devicetype` `dt` on((`dt`.`ID_DeviceType` = `d`.`ID_DeviceType`))) join `mediumtype` `mt` on((`mt`.`ID_MediumType` = `dt`.`ID_MediumType`))) where (not(exists(select 'x' from `relnetworkinterface` `rn` where ((`rn`.`ID_NetworkinterfaceA` = `ni`.`ID_Networkinterface`) or (`rn`.`ID_NetworkinterfaceB` = `ni`.`ID_Networkinterface`))))) order by `d`.`Hostname` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2015-08-25 19:56:38
